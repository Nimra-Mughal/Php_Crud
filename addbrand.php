            ...
            <nav class="navbar bg-light shadow-lg">
                ...
                <div class="w-75 mx-auto pt-3">
                    ...
                    <div class="row pt-3 mt-2">
                        <form action="insertbrand.php" enctype="multipart/form-data" method="post" class=" mx-auto mt-3 bg-light shadow-lg p-3">
                            ...
                            <input type="submit" name="insertbrand" class="btn btn-dark mx-auto d-block mt-3">
                        </form>
                    </div>
                </div>    
            </div>
